...
/**
 * Query input for looking up a Local Gateway
 */
export interface LocalGatewayContextQuery extends ContextLookupRoleOptions {
  /**
   * Filters to apply to the Local Gateway
   *
